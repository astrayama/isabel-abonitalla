      ...
      <div className="w-full max-w-3xl flex flex-col items-center">
        <OSWindow title="welcome.exe" className="w-full">
          <div className="p-8 md:p-12 flex flex-col items-center text-center">
            <h1 className="text-6xl md:text-7xl font-mono font-bold text-retro-dark mb-4">
              Hi!
            </h1>
            <h2 className="text-4xl md:text-5xl font-mono text-retro-dark mb-6">
              I'm Isabel,
            </h2>
            
            <div className="flex items-center justify-center h-12 mb-8">
              <span className="text-3xl md:text-4xl font-mono font-bold bg-gradient-to-r from-brand-pink to-brand-purple text-transparent bg-clip-text">
                {displayText}
              </span>
              <span className="text-3xl md:text-4xl font-mono text-retro-dark animate-pulse">
                |
              </span>
            </div>

            <p className="text-sm text-gray-500 font-mono mb-8">
              Purdue 🌐 | 18x hackathon winner 🏆
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              {[
                ...
                return (
                  ...
                  >
                    ...
                    <span className="font-mono text-[10px] text-gray-400 group-hover:text-brand-purple transition-colors">
                      {link.label}
                    </span>
                  </a>
                );
              ...
              <a href="/resume.pdf" target="_blank" rel="noopener noreferrer"
                ...
                <span className="font-mono text-[10px] text-brand-purple">resume</span>
              </a>
            </div>
          </div>
        </OSWindow>
